...
## M5-D30 收官；进入第6月（Port/Adapter）

### 为什么
填收官清单；跑全量 eval；确认第6月入口（已开课主线，不必再从旧菜单「只选一条」）。
...
**已排定：** 第6月后进入第7月规则引擎 → 第8月工作流可视化（完整教材）。  
观测大盘 / 灰度演练等留作第9月及以后可选，见 [CURRICULUM_CONTINUITY.md](./CURRICULUM_CONTINUITY.md)。

### 怎么做
上午：清单+baseline+三场景  
下午：打开第6月合订，写 5 行开读计划 + pitch 三句
...
| 误区/现象 | 为什么危险 | 今天怎么避 |
|---|---|---|
| 第6月想并行观测+规则 | 做不深 | 跟已开课主线；见 CONTINUITY |
| 删除失败 eval | 失真 | 保留成长 |
...
**Q: 第6月学什么？**  
A: 已开课主线是**Port/Adapter 稳定化**（Fake/Sandbox + 契约测）。见 [`MONTH6.md`](../MONTH6.md)。规则引擎是第7月；观测/灰度等见 [CURRICULUM_CONTINUITY.md](./CURRICULUM_CONTINUITY.md)。
...
| 2026-08-15 | 连贯补丁：收官/FAQ 指向已开课第6月；链接 CONTINUITY |
