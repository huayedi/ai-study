...
> **节奏：** 每天约 2～3 小时。  
> **第 1 月正文合订（逐日详版，非概述）：** [`MONTH1_DAY1-30_COMBINED.md`](./MONTH1_DAY1-30_COMBINED.md) · 入口 [`docs/MONTH1.md`](../MONTH1.md)
...
### Day13～30 ✅ 已扩成逐日详版并入合订本
- **主阅读：** [`MONTH1_DAY1-30_COMBINED.md`](./MONTH1_DAY1-30_COMBINED.md)（Day13～30 含完整概念/骨架/坑/验收，非概述）  
- 旧文件 `day13-30-combined.md` 仅备份  

---

## 每日标准学习流程（以后都按这个）

1. **读当天讲义**（主任务：合订本中对应 Day，或保留的单日 md）  
2. **按讲义中的顺序打开对应代码**（对照，不要求先写）  
3. **可选：** 启动项目，按讲义里的示例请求看一眼现象  
4. 有疑问直接问；需要时我再补「加餐短讲义」  

详细讲义规则：  
- **第 1 月全文：** [`MONTH1_DAY1-30_COMBINED.md`](./MONTH1_DAY1-30_COMBINED.md)（Day1～30 逐日详版）  
- Day8～12 原单日文件仍保留作备份  
...
| 11 | ✅ | Embedding 原理 |
| 12 | ✅ | 向量检索实现 |
| 13～30 | 📖 | 见 [MONTH1 合订本](./MONTH1_DAY1-30_COMBINED.md) |
...
| 2026-08-15 | 第1月改为合订详版 `MONTH1_DAY1-30_COMBINED.md`（非概述） |
